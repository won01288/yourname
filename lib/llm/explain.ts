      ...
      properties: {
        ...
        body: {
          ...
          description:
            ...
            "마지막 문단은 당사자에게 건네는 따뜻한 조언으로 맺는다.",
        },
      },
      required: ["title", "body"],
        ...
        properties: {
          ...
          explanation: {
            ...
            description:
              ...
              "수리사격(81수리) 길흉 → 자원오행 순서로, 이 이름이 왜 선택됐는지 그 과정을 이해하기 쉽고 " +
...
마라. 직설적이거나 무겁지 않게, 따뜻하고 희망적인 정서로 쓰고 마지막 문단은 당사자에게
건네는 부드러운 조언으로 맺어라.
...
export async function explainCandidates(input: ExplainCandidatesInput): Promise<NamingReport> {
  ...
  const response = await anthropic.messages.create({
    ...
    system:
      ...
      "이 사람의 사주를 은유적이고 감성적인 톤으로 풀어 쓴 sajuStory를 작성한다. 신강/신약·용신·발음오행 상생· " +
