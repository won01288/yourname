...
export default function SajuReportCard({ elementDistribution, yongsin, dayStem }: SajuReportCardProps) {
  ...
  return (
    <section className="relative mb-8 rounded-card border border-border bg-surface p-6 shadow-[var(--shadow-elevated)] sm:p-8">
      ...
      <ElementDistributionChart distribution={elementDistribution} dayStem={dayStem} />
